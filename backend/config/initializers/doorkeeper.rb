Doorkeeper.configure do
  ...
  resource_owner_authenticator do
    ...
    # Store the request url for Devise to redirect to after sign-in.
    # See https://github.com/plataformatec/devise/blob/v4.4.1/lib/devise/controllers/store_location.rb#L51
    current_user || begin
